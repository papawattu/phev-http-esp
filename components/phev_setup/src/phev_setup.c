...
void phev_setup_parseConnectionConfig(connectionDetails_t * config, cJSON * connection)
{
    ...
    {
        config->host = strdup(phev_config_getConfigString(connection, SETUP_CONNECTION_CONFIG_HOST));
    } 
    else 
    {
...
void phev_setup_parsePPPConfig(connectionDetails_t * config, cJSON * ppp)
{
    ...
    {
        config->pppUser = strdup(phev_config_getConfigString(ppp, SETUP_PPP_CONFIG_USER));
    } 
    else 
    {
    ...
    {
        config->pppPassword = strdup(phev_config_getConfigString(ppp, SETUP_PPP_CONFIG_PASSWORD));
    } 
    else 
    {
    ...
    {
        config->pppAPN = strdup(phev_config_getConfigString(ppp, SETUP_PPP_CONFIG_APN));
    } 
    else 
    {
...
esp_err_t post_handler(httpd_req_t *req)
{
    ...
    phevSetupConnectionConfig_t * config = malloc(sizeof(phevSetupConnectionConfig_t));
