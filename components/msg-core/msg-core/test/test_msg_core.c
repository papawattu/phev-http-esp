...
void test_msg_core_publish_returns_zero(void)
{
...
void test_msg_core_publish_calls_outgoing_handler(void)
{
...
void test_msg_core_register_handlers_returns_zero(void)
{
    messagingClient_t * client = NULL;
...
void test_msg_core_register_handlers_can_be_called(void)
{
    messagingClient_t * client = NULL;
...
void test_msg_core_published_message_data(void)
{
    messagingClient_t * client = NULL;
...
void test_msg_core_create_messaging_client()
{
...
void test_msg_core_create_messaging_client_start()
{
    messagingSettings_t settings;
...
void test_msg_core_create_messaging_client_stop()
{
    messagingSettings_t settings;
...
void test_msg_core_create_messaging_client_connect()
{
    messagingSettings_t settings;
...
void test_msg_core_messaging_client_start()
{
    messagingSettings_t settings;
    settings.start = mock_start;
    messagingClient_t * client = msg_core_createMessagingClient(settings);
...
void test_msg_core_messaging_client_stop()
{
    messagingSettings_t settings;
    settings.stop = mock_stop;
    messagingClient_t * client = msg_core_createMessagingClient(settings);
...
void test_msg_core_messaging_client_connect()
{
    messagingSettings_t settings;
    settings.connect = mock_connect;
    messagingClient_t * client = msg_core_createMessagingClient(settings);
...
void test_msg_core_messaging_client_connect_default()
{
    messagingSettings_t settings = {};
    messagingClient_t * client = msg_core_createMessagingClient(settings);
...
void test_msg_core_create_messaging_client_default_settings()
{
    messagingSettings_t settings;
...
void test_msg_core_create_messaging_client_default_settings_call_start()
{
    messagingSettings_t settings = {
        .connect = NULL,
        .start = NULL,
...
void test_msg_core_create_messaging_client_default_settings_call_stop()
{
    messagingSettings_t settings = {
        .connect = NULL,
        .start = NULL,
...
void test_msg_core_create_messaging_client_default_settings_call_connect()
{
    messagingSettings_t settings = {
        .connect = NULL,
        .start = NULL,
...
void test_msg_core_messaging_pub_sub()
{
    messagingSettings_t settings;
    message_t * message = malloc(sizeof(message_t));
